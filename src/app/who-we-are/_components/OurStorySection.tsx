...
export function OurStorySection() {
  return (
    <>
      ...
      <section
        id="our-story"
        className="relative bg-gradient-to-br from-gray-50 via-white to-gray-50 py-24"
      >
        <Container>
          <div className="mx-auto max-w-4xl text-center">
            <h2
              className="mb-6 text-5xl font-black tracking-tight text-gray-900 md:text-6xl lg:text-7xl"
          ...
          <div className="mx-auto max-w-4xl">
            ...
            >
              <p>
                ...
                <span className="font-semibold text-[#00a54f]">
                  Mandala Agrifresh
                </span>{" "}
            ...
            <div className="order-2">
              ...
              >
                <p>
                  ...
                  for not looking "perfect." Safe and nutritious fruit was being
                  discarded in the name of aesthetics.
                </p>
                <p>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
            <div className="order-2 lg:order-1">
              <div className="mb-4 inline-block rounded-full bg-[#00a54f]/10 px-4 py-2">
                <span
                  className="text-sm font-bold tracking-wide text-[#00a54f]"
                  style={{ fontFamily: "Gilroy, sans-serif" }}
                >
                  2025
                </span>
      ...
      <section className="bg-gradient-to-br from-[#00a54f] to-[#1acf1b] py-20 text-white">
        <Container>
          <div className="mx-auto max-w-4xl text-center">
            ...
            <blockquote
              className="mb-8 text-2xl font-light leading-relaxed md:text-3xl"
              style={{ fontFamily: "Gilroy, sans-serif" }}
            >
              Our products are more than food. They are proof that waste can
